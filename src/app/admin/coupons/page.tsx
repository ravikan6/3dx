  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="flex-1 p-8 space-y-6">
        ...
        <div className="mt-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-6">Coupon List</h2>
                ...
                >
                  <div className="flex justify-between items-center">
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Discount: {coupon.discount}%</p>
                      <p className="text-sm text-gray-500">Expires: {coupon.expiryDate}</p>
                    </div>
